		...
		<div class="grid md:grid-cols-3 gap-8">
			...
			<div>
				...
				<p class="text-gray-300 mb-4">
					{PROFILE.title} passionate about creating innovative solutions and building amazing user experiences.
				</p>
				...
				<div class="flex space-x-4 mb-4">
					{#each SOCIAL_LINKS as social}
						<a
							...
							class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-300 hover:text-white hover:bg-gray-700 transition-colors"
						...
						>
							...
							{:else}
								<span class="text-sm font-medium">{social.name.charAt(0)}</span>
							{/if}
						</a>
					{/each}
				</div>
		...
		<div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
			...
			<div class="flex items-center space-x-6">
				...
				<button
					...
					class="p-2 bg-gray-800 rounded-lg text-gray-300 hover:text-white hover:bg-gray-700 transition-colors"
